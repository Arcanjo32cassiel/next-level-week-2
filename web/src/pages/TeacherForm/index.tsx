        ...
        <div id="page-teacher-form" className="container">
           ...
           <main>
               <form onSubmit={handleCreateClass}>
                    ...
                    <fieldset>
                        <legend className="legendsobre">Sobre a aula</legend>
                            ...
                            Horários disponiveis
                                ...
                                return(
                                    ...
                                    <Select 
                                        ...
                                        onChange={e => setSchenduleItemValue(index, 'week_day', e.target.value)}
                                        options={[
                                    ...
                                    value={scheduleItem.from}
                                     onChange={e => setSchenduleItemValue(index, 'from', e.target.value)}/>
                                    <Input name="to" label="Até" type="time"
                                     value={scheduleItem.to}
                                     onChange={e => setSchenduleItemValue(index, 'to', e.target.value)}/>
                                </div>
                                )
                            })}
